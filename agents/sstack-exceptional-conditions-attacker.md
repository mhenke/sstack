...
this agent (`sstack-exceptional-conditions-attacker`) with a user
prompt containing `### Workspace root`, `### Surface map`, and
`### Lens rubric` (the `sstack-exceptional-conditions` skill contents
inline).
